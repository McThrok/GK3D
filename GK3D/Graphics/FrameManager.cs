    ...
    public class FrameManager
    {
        ...
        public void RenderFrame(float aspect)
        {
            ...
            foreach (var v in Collection.SceneObjects.GetPrimitivesWiThGlobalModelMatrices())
            {
                ...
                // Update model view matrices
                var modelMatrix = v.Value;
                var modelViewProjectionMatrix = modelMatrix * Collection.ActiveCamera.GetViewMatrix() * Matrix4.CreatePerspectiveFieldOfView(1.3f, aspect, 0.1f, 40.0f);
                ...
                GL.UniformMatrix4(Collection.ActiveShader.GetUniform("modelviewproj"), false, ref modelViewProjectionMatrix);
